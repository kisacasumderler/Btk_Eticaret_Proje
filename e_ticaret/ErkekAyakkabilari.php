...
$AnamMenuTumKayitlarSayiSorgu = $db->prepare("SELECT SUM(urunSayisi) AS MenununToplamUrunu FROM menuler WHERE urunTuru='Erkek Ayakkabısı'");
...
<ul class="MenuVeBanner">
    <li class="Menuler">
        <div class="menulerHeader">
            ...
            <nav>
            <a href="index.php?SK=84" class="light" style="">Tüm Ürünler (<?php echo $ToplamSayi["MenununToplamUrunu"]; ?>) </a>
    <?php 
    ...
    if($MenulerKSayi>0){
        foreach($MenulerKayitlar as $values){
            ?>
        <a href="index.php?SK=84&ID=<?php echo DonusumleriGeriDondur($values["id"]) ?>" class="light" style="color :<?php if ($GelenID == $values["id"]) {echo "#FF7A38";}else{echo "#646465";} ?>;"><?php echo DonusumleriGeriDondur($values["MenuAdi"]) ?> (<?php echo DonusumleriGeriDondur($values["urunSayisi"]) ?>)</a>
            <?php
        }
    }else {
...
<ul class="urunler">
    ...
    <ul class="urunlerListele">
        <?php 
            $UrunlerSorgu = $db->prepare("SELECT * FROM urunler WHERE urunTuru='Erkek Ayakkabısı' AND Durumu='1' {$MenuKosulu} {$AramaKosulu} ORDER BY id DESC LIMIT $SayfalamayaBaslanacakKayitSayisi, $SayfaBasinaKayitSayisi");
            ...
            if($UrunlerKS>0){
                ...
                if($puanHesapla==0){
                    ...
                    <li>
                        ...
                        <div class="urunimg">
                            <a href="<?php echo DonusumleriGeriDondur(SEO($values["urunTuru"]))."/".DonusumleriGeriDondur(SEO($values["urunAdi"]))."/".DonusumleriGeriDondur($values["id"]); ?>"><img src="./resimler/UrunResimleri/Erkek/<?php echo DonusumleriGeriDondur($values["urunResmiBir"])?>" alt=""></a>
        ...
        ?>
            <div class="sayfalarKapsam">
                ...
                <div class="SayfalamaButtons">
                    <?php 
                    if($Sayfalama>1){
                        echo "<span><a href='index.php?SK=84".$SayfalamaKosulu."&SYF=1' class='light'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d='M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160zm352-160l-160 160c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L301.3 256 438.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0z'/></svg></a></span>";
                        $Sayfa1GeriAl = $Sayfalama - 1;
                        echo "<span><a href='index.php?SK=84".$SayfalamaKosulu."&SYF=".$Sayfa1GeriAl."' class='light'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 320 512'><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d='M41.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.3 256 246.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z'/></svg></a></span>";
                    }
                    for ($SayfalamaSayfaIndexi = $Sayfalama - $SayfalamaIcinSolveSagButonSayisi; $SayfalamaSayfaIndexi <= $Sayfalama + $SayfalamaIcinSolveSagButonSayisi; $SayfalamaSayfaIndexi++){
                                if(($SayfalamaSayfaIndexi>0)and($SayfalamaSayfaIndexi<=$BulunanSayfaSayisi)){
                                    if($SayfalamaSayfaIndexi==$Sayfalama){
                                        ...
                                        echo "<span><a href='index.php?SK=84".$SayfalamaKosulu."&SYF=" . $SayfalamaSayfaIndexi . "' class='light'>".$SayfalamaSayfaIndexi."</a></span>";
                                    }
                                }
                    }
                    if($Sayfalama!=$BulunanSayfaSayisi){
                        $Sayfa1IleriAl = $Sayfalama + 1;
                        echo "<span><a href='index.php?SK=84".$SayfalamaKosulu."&SYF=".$Sayfa1IleriAl."' class='light'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 320 512'><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d='M278.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-160 160c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L210.7 256 73.4 118.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l160 160z'/></svg></a></span>";

                        echo "<span><a href='index.php?SK=84".$SayfalamaKosulu."&SYF=".$BulunanSayfaSayisi."' class='light'><svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 512 512'><!--! Font Awesome Pro 6.2.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. --><path d='M470.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L402.7 256 265.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160zm-352 160l160-160c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L210.7 256 73.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0z'/></svg></a></span>";
                    }
                    ?>
                </div>
            </div>
